...
class FGMembersite
{
	...
	function getMonthlyData ($flag)
	{
		...
		$month = $this->getMonth($flag);
		$year = $this->getYear($flag);
		$qry = "SELECT day, category, amount, memo FROM spending_data WHERE month=$month AND year=$year AND username='$_SESSION[username]' ORDER BY day DESC";
		$result = mysql_query($qry,$this->connection);
